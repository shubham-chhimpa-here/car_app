...
export default function Navbar() {
    return <>
        <nav className="bg-gray-200 shadow shadow-gray-300 w-100 px-8 md:px-auto sticky top-0 z-50">
	<div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
		...
		<div className="text-gray-500 order-3 w-full md:w-auto md:order-2">
			<ul className="flex font-semibold justify-between">
				...
				{/* <li className="md:px-4 md:py-2 hover:text-indigo-400"><Link to="/search">Search</Link></li>
				<li className="md:px-4 md:py-2 hover:text-indigo-400"><Link to="/explore">Explore</Link></li>
